...
?>
    ...
    <div class="postbox">
        <div class="inside">
            ...
            <p>メニューの編集画面へ移動したら、編集画面内の左側にある<strong>「フォームズ フォームリンク」</strong>項目をクリックしてください。
            （「フォームズ フォームリンク」項目が表示されない場合は、管理画面右上にある「表示オプション」をクリックして、「フォームズ フォームリンク」をクリックしてください。）</p>
